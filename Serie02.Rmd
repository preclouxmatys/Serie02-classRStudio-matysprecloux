...
We could use logistic regression to predict whether an individual snores or not, based on their age, weight, and alcohol consumption. This would allow us to identify risk factors for snoring.

#### Can you classify individuals based on their variables?

Clustering methods (such as k-means) could be applied to group individuals with similar profiles (e.g., heavy drinkers and smokers vs. non-drinkers and non-smokers). This would provide insight into lifestyle patterns.
